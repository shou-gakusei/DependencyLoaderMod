...
public record ModMetadata : AbstractModMetadata
{
    ...
    public override string ModGuid { get; init; } = "com.whfwtf.dependency-loader-mod";
    public override string Name { get; init; } = "DependencyLoaderMod";
...
) : IOnLoad
{
    public async Task OnLoad()
    {
        ...
        try
        {
            ...
            {
                var configJson = JsonNode.Parse(await File.ReadAllTextAsync(configPath));
